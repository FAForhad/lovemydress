 ...
 <style>
    ...
    <main class="blogs">
        <section>
            ...
            <article>
                <div class="mb-10">
                    <img class="bg-center rounded-md bg-no-repeat bg-cover w-full mb-10 lg:object-none object-contain" src="/article_images/<?php echo $dm['image']; ?>" title="<?php echo $dm['title']?>" alt="<?php echo $dm['title']?>"></img>
